...
<div class="stock-hero"><div><h1>Gestiune stocuri DDD</h1><p>Nomenclator produse, intrări, ieșiri și notificări de stoc minim.</p></div><div class="stock-actions"><a class="btn accent" href="stock_products.php">Produs nou</a><a class="btn" href="stock_receipts.php">Intrare stoc</a><a class="btn" href="stock_movements.php">Scoate din stoc</a></div></div>
<?php render_stock_module_nav('dashboard'); ?>
<div class="stock-kpis"><div class="stock-kpi"><div class="label">Produse</div><div class="value"><?= (int)$totalProducts ?></div></div><a class="stock-kpi" href="stock_notifications.php"><div class="label">Notificări stoc minim</div><div class="value"><?= (int)$lowStock ?></div></a><div class="stock-kpi"><div class="label">Mișcări stoc</div><div class="value"><?= (int)$movementsCount ?></div></div><div class="stock-kpi"><div class="label">Unități totale</div><div class="value"><?= stock_h(stock_fmt_qty($totalQty)) ?></div></div></div>
<?php if ($lowStock > 0): ?><div class="notice notice-danger"><strong>Atenție:</strong> există <?= (int)$lowStock ?> produs(e) la sau sub stocul minim. <a href="stock_notifications.php" style="font-weight:900;text-decoration:underline;">Vezi notificări</a></div><?php endif; ?>
