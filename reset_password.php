...
<main class="login-shell">
    <div class="login-card">
        ...
        <h1 class="login-title">Parola noua</h1>
                ...
                <form method="post" autocomplete="on">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <span class="input-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="4" y="10" width="16" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></span>
                            <input id="password" type="password" name="password" required autocomplete="new-password" minlength="8" placeholder="Minimum 8 caractere">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <span class="input-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="4" y="10" width="16" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></span>
                            <input id="password_confirm" type="password" name="password_confirm" required autocomplete="new-password" minlength="8" placeholder="Reintrodu parola">
                        </div>
                    </div>
