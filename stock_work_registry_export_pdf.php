...
<table><thead><tr><th>Data</th><th>Beneficiar</th><th>Procedura</th><th>Produs biocid</th><th>Nr. aviz</th><th>Lot</th><th>Cantitate</th><th>Concentratie</th><th>Nr. PV</th><th>Lucratori</th></tr></thead><tbody>
...
<?php endforeach; ?>
<?php if(!$rows): ?><tr><td colspan="10">Nu exista inca inregistrari de consum PV in intervalul selectat.</td></tr><?php endif; ?>
</tbody></table>
<div class="footer">Registrul se completeaza automat din consumurile legate de procesele verbale.</div>
</body></html>
<?php
$html = ob_get_clean();
