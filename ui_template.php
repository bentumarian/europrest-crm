        ...
        <div class="ds-card">
            ...
            <div class="ds-card-body">
                <div class="ds-demo" style="margin-bottom:14px">
                    <div style="font-family:Inter,system-ui,sans-serif;font-size:24px;font-weight:700;color:#0F172A;line-height:1.2">PestZone CRM — Interfață operațională</div>
                    <div style="font-family:Inter,system-ui,sans-serif;font-size:13px;font-weight:500;color:#64748B;margin-top:6px">Clienți · Lucrări · Facturare · Stocuri · Rapoarte</div>
                </div>
